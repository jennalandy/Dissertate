...
3. File > Settings > Change compiler to `XeLaTeX`
4. Minor changes required in [`assets/schools/Harvard/style.sty`](assets/schools/Harvard/style.sty):
    - Line 58: Update copyright year with your year of completion
    - Line 71: If applicable, replace ``Dissertation'' with ``Thesis''
5. Update personal information in [`assets/latex-base/frontmatter`](assets/latex-base/frontmatter)
...
6. Write dissertation content inside of [`assets/latex-base/chapters`](assets/latex-base/chapters)
